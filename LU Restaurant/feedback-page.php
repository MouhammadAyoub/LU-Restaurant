...
include("./components/feedback/rating.php");
include("./components/feedback/top_clients.php");
include("./components/feedback/top_items.php");
include("./components/feedback/feedbackvisit.php");
