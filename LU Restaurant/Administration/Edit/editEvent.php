        ...
        <div class="main-panel">
            ...
            <center>
                <div style="width: 600px;">
                    ...
                    <h2 style="margin-bottom:40px;color:rgb(43,96,142);">Edit Event</h2>
                    ...
                    <form method="post" action="../events.php" enctype="multipart/form-data">
                        ...
                        <input type="text" name="name" placeholder="Name" value="<?php echo $event[0][2]; ?>" ><br/>
                        <textarea name="description" placeholder="Description" ><?php echo $event[0][3]; ?></textarea><br/>
                        <input type="datetime-local" name="date"  value="<?php echo $date; ?>" ><br/>

                        <p style="margin-left:100px;">
                            <span style="font-size:20px;">Change Image</span>
                            <input style="margin-top:20px; margin-bottom:20px;margin-left:30px;" type="file" name="image">
                        </p>
