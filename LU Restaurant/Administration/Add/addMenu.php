...
if(empty($menu_name)){
    ...
    if(check_menu_name($menu_name)==false){
        $message= "This menu name is already exist";    
    }
    else{
        addMenu($menu_name);
        ...
        <nav class="navbar navbar-expand-lg " color-on-scroll="500">
            ...
            <center>
                <div style="width: 600px;">
                    ...
                    <h2 style="margin-bottom:40px;color:rgb(43,96,142);">Add New Menu</h2>

                    <form method="post" action="./addMenu.php">
                        <p class="error"><?php echo isset($message)?$message:""?></p>
                        <input type="text" name="menu_name" placeholder="Menu Name"><br/>
