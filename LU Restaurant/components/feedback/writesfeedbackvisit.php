...
if(isset($_POST["submitFeedback"])){
  ...
  if( !strlen(trim($_POST['comment'])) || empty($_POST["rating"]) || $message != "" ){
    $message = "All fields must be filled out";
    echo "<script src=\"http://code.jquery.com/jquery-1.9.1.min.js\"></script>";
    echo "<script src=\"https://cdnjs.cloudflare.com/ajax/libs/toastr.js/2.0.1/js/toastr.js\"></script>";
    ...
    if(isset($_POST["firstName"])) addCustomer($firstName,$lastName,$_POST["phone"],$address);
    addFeedBack($_POST["phone"],$rate,$comment,date("Y-m-d H:i:s"));
    echo "<script src=\"http://code.jquery.com/jquery-1.9.1.min.js\"></script>";
    echo "<script src=\"https://cdnjs.cloudflare.com/ajax/libs/toastr.js/2.0.1/js/toastr.js\"></script>";
    echo "<script type=\"text/javascript\">";
    echo "toastr.options = {\"positionClass\" : \"toast-custom\"};";
...
<form action="./writesfeedbackvisit.php" method="post">
              
              <p style="color:red; margin-top:-20px;"><?php echo isset($message)?$message:"";?></p>

              <?php if(isset($_GET["test"]) || isset($_POST["firstName"])){ ?>

                <input type="text" class="form-control" name="firstName" value="<?php echo $firstName; ?>" placeholder="Your First Name" />
            
                <input type="text" class="form-control" name="lastName" value="<?php echo $lastName; ?>" placeholder="Your Last Name" />
            
                <input type="text" class="form-control" name="address" value="<?php echo $address; ?>" placeholder="Address" />

              <?php } ?>

              <input type="hidden" name="phone" value="<?php echo isset($_GET["phone"])?$_GET["phone"]:$_POST["phone"]; ?>" />

              <div class="rating" style="margin-bottom: 40px;">
                <div  class="rateyo" id= "rateYo"
                      data-rateyo-rating="<?php echo $rate > 0 ? $rate : 0; ?>"
            ...
            <textarea   style="width: 500px; height: 150px;"
                      placeholder="Enter your feedback..." name="comment"><?php echo $comment; ?></textarea>
<br/>
<br/>
<br/>
          ...
          <input style="  display: inline-block;
            ...
            <input style="  display: inline-block;
              ...
              border: none;
              margin-bottom:100px;"
      type="submit" value="Submit" name="submitFeedback"/> 
