        ...
        <nav class="navbar navbar-expand-lg " color-on-scroll="500">
            ...
            <center>
                <div style="width: 600px;">
                    ...
                    <h2 style="margin-bottom:70px;color:rgb(43,96,142);">Delete Table</h2>
                    ...
                    <form method="post" action="../tables.php" >
                        ...
                        <p style="font-size: 21px;margin-bottom:30px;">Table ID: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    
                            <input  value="<?php echo $table[0][0];?>"  
                                type="number" 
                                name="id" 
                                min="0" 
                                readonly
                            ...
                            <input  value="<?php echo $table[0][2];?>"  
                                type="number" 
                                name="numberChairs" 
                                min="0" 
                                style="width: 70px;"
                        ...
                        <p style="font-size: 21px;">Occupied 
                        
                        <input <?php echo $table[0][1]?"checked":"";?> 
                            type="checkbox" 
                            name="isFree" 
