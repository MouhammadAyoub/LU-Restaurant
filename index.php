...
include("./components/index/new_offers.php");
include("./components/index/events.php");?>
<center><h1 style="margin:140px 0px -70px 0px; font-size:45px;"><B>Menus</B></h1></center>
<?php include("./components/general/our_menu.php");
include("./components/general/about.php");
include("./components/general/book.php");
include("./components/general/client.php");
?>
